...
import (
	...
	resourcemanager "github.com/kozmoai/builder-backend/src/utils/kozmoresourcemanagersdk"
	parser_template "github.com/kozmoai/builder-backend/src/utils/parser/template"
)
...
func (r *AIAgentConnector) Run(resourceOptions map[string]interface{}, actionOptions map[string]interface{}, rawActionOptions map[string]interface{}) (common.RuntimeResult, error) {
	...
	// call api
	api, errInNewAPI := resourcemanager.NewkozmoResourceManagerRestAPI()
	if errInNewAPI != nil {
