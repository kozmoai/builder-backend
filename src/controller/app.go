...
import (
	...
	"github.com/kozmoai/builder-backend/src/response"
	...
	"github.com/kozmoai/builder-backend/src/utils/datacontrol"
	"github.com/kozmoai/builder-backend/src/utils/kozmomarketplacesdk"
)
...
func (controller *Controller) ForkMarketplaceApp(c *gin.Context) {
	...
	go func() {
		...
		marketplaceAPI.ForkCounter(kozmomarketplacesdk.PRODUCT_TYPE_APPS, appID)
	}()
