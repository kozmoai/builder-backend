...
import (
	...
	"github.com/kozmoai/builder-backend/src/request"
	"github.com/kozmoai/builder-backend/src/utils/accesscontrol"
	"github.com/kozmoai/builder-backend/src/utils/auditlogger"
	"github.com/kozmoai/builder-backend/src/utils/kozmoaiperipheralapisdk"
)
...
func (controller *Controller) GenerateSQL(c *gin.Context) {
	...
	generateSQLPeripheralRequest, errInNewReq := kozmoaiperipheralapisdk.NewGenerateSQLPeripheralRequest(resource.ExportTypeInString(), resourceMetaInfo.ExportSchema(), generateSQLRequest.Description, generateSQLRequest.GetActionInString())
	if errInNewReq != nil {
	...
	peripheralAPI := kozmoaiperipheralapisdk.NewIllaCloudPeriphearalAPI()
